...
Public Class frmEspecialidades
        ...
        Try
            ...
            Using command As New MySqlCommand(insertQuery, conn)
                ...
                If rowsAffected > 0 Then
                    ...
                    txt_especialidad.Focus() ' Poner el foco en el campo de usuario
    ...
    Sub cargarEspecialidades()
        Try
            'ANTES DE REALIZAR EL INSERT  HACE U SELECT, SE TRAEN EL ULTIMO ID Y LE SUMAN 1
            Dim conn = conexion.Abrir()
    ...
    Private Sub dgv_especialidades_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_especialidades.CellContentClick
        ...
        If e.RowIndex >= 0 Then
            ...
            txt_especialidad.Text = descripcion ' Mostrar la descripción en el TextBox
            lbl_id.Text = especialidadId.ToString() ' Mostrar el ID en la etiqueta lbl_id
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Integer.TryParse(lbl_id.Text, id_especialidad) Then
            Try
                Dim conn = conexion.Abrir()
